(defproject cljs-d3 "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "cljs-d3.core/on-figwheel-reload"}

                :compiler {:main cljs-d3.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/cljs_d3.js"
